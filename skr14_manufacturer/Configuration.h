...
#define STRING_CONFIG_H_AUTHOR "LaXiS96" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 V2 - BTT SKRv1.4"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Ki   4.09
    #define DEFAULT_Kd  69.02
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Ender 3 V2
  #define DEFAULT_bedKp 101.84
  #define DEFAULT_bedKi  19.85
  #define DEFAULT_bedKd 348.30
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -10, -1.22 }
